...
<section class="section-padding ">
    <div class="container ">
        <div class="row ">
            ...
            <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4 ">
                <div class="featured-block d-flex justify-content-center align-items-center ">
                    <a href="{{route('donation')}}" class="d-block " style="text-decoration:none;">
        ...
        <div class="row ">
            ...
            <div class="col-lg-6 col-12 ">
                ...
                <form class="custom-form volunteer-form mb-5 mb-lg-0 " method="POST" action="{{route('home')}}" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="custom-btn pt-2 pb-2" name="form2" style="text-decoration:none; font-weight:lighter; font-size:large;">Submit</button>
                </form>
            </div>
        ...
        <div class="row ">
            ...
            <div class="col-lg-4 col-12 ms-auto mb-5 mb-lg-0 ">
                <div class="contact-info-wrap ">
                    ...
                    <div class="contact-info ">
                        ...
                        <a href="https://www.google.com/maps/search/Galle+Road,+Colombo+06/@6.8948446,79.8342626,14z/data=!3m1!4b1?entry=ttu" class="custom-btn mt-2 pt-2 pb-2" style="text-decoration:none;">Get Direction</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5 col-12 mx-auto ">
                <form class="custom-form contact-form " method="POST" action="{{route('home')}}" role="form ">
                    ...
                    <button type="submit" class="custom-btn mt-3 pt-2 pb-2" style="text-decoration:none; font-weight:lighter; font-size:large;" name="form3">Send Message</button>
                </form>
            </div>
