...
<section class="section-padding section-bg mt-0 pt-2">
    <div class="col-12 mt-0 pt-0">
        <div class="custom-text-box mt-2 " style="margin:10px 100px;padding:20px 20px;">
            <h6 class="mb-3 text-center">Finished Appointments</h6>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border:1px solid black; padding:10px;" class="text-center">
                                <a href="/prescription/{{Auth::user()->id}}/{{$appo->id}}" class="btn btn-primary" style="font-size:15px;font-weight:bold;">Prescription</a>
                            </td>
                            <td style="border:1px solid black; padding:10px;" class="text-center">
                                <a href="/medical-certificate/{{Auth::user()->id}}/{{$appo->id}}" class="btn btn-info" style="font-size:15px;font-weight:bold;">Generate Medical Certificate</a>
                            </td>
                        </tr>
                        @endforeach
                <tbody>
