...
<section class="section-padding section-bg mb-0 pt-1">
  <div class="container-fluid pt-3">
    <div class="row custom-text-box" style="margin:0 20px;">
      ...
      <div class="col-md-3 mb-3">
        <div class="card bg-danger text-white h-100" style="text-align:center;">
          ...
          <div class="card-footer d-flex">
            <a href="{{ route('viewearnings') }}" style="color:white;">View Details</a>
            <span class="ms-auto">
              <i class="bi bi-chevron-right"></i>
            </span>
          </div>
    ...
    <div class="row mt-3 custom-text-box " style="margin:0 20px;">
      <h5 style="text-align:center;">Today's Appointments</h5>
