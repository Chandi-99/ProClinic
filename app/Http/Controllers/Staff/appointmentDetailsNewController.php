...
class appointmentDetailsNewController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return view('staff.appointmentdetails', ['appointments' => $appointments, 'doctors' => $doctors, 'patients' => $patients, 'search_appointments'=> $appointmentArray ]);
        }
    }
}
